...
pub enum QueryResponseKind {
    ...
    TokenBalanceList(near_primitives::views::TokenBalanceList),
    DynamicConfig(near_primitives::views::DynamicConfig),
    TokenProperties(near_primitives::views::TokenProperties),
}
